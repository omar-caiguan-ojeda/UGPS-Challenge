...
// const API_KEY = "5e8b5c51f070483db815485502ff0a48"; // Reemplaza con tu clave de RAWG
...
//     count: data.count || 0, // Total de juegos disponibles
//     next: data.next, // URL de la siguiente página (si existe)
//     previous: data.previous, // URL de la página anterior (si existe)
//   };
// };
