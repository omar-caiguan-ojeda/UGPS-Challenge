...
// /**
//  * Component to handle game filtering and search.
//  */
...
//   return (
//     <Box bg="gray.900" p={5} borderRadius="lg" boxShadow="lg">
//       <VStack spacing={4}>
//         <FormControl>
...
//         </FormControl>
//         <FormControl>
//           <FormLabel color="white">Año</FormLabel>
//           <Input
//             value={year}
...
//             {/* Agrega más géneros según la API */}
//           </Select>
//         </FormControl>
//         <FormControl>
//           <FormLabel color="white">Plataforma</FormLabel>
//           <Select
//             value={platform}
...
//             {/* Agrega más plataformas según la API */}
//           </Select>
//         </FormControl>
//         <Button
//           colorScheme="cyan"
