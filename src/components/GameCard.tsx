...
// import { GiJoystick } from "react-icons/gi"; // Ícono de joystick

// interface GameCardProps {
//   game: Game;
// }

// // Combinamos motion y Link en un componente animado
// const MotionLink = motion(Link);

// /**
//  * Responsive game card with clickable area and modern design.
//  */
// export const GameCard = ({ game }: GameCardProps) => {
//   // Colores dinámicos para el tema Claro/Oscuro
...
//     <Box
//       as={MotionLink}
//       to={`/game/${game.id}`} // Enlace a la página de detalles
//       bg={bgColor}
//       borderRadius="lg"
//       overflow="hidden"
