...
//   if (!game) return <Text textAlign="center" py={10}>Cargando...</Text>;

//   return (
//     <Container maxW={{ base: "100%", md: "container.lg" }} py={{ base: 6, md: 10 }} px={{ base: 4, md: 0 }}>
//       <Box
//         as={motion.div}
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition="all 0.5s ease"//{{ duration: 0.5 }}
//       >
